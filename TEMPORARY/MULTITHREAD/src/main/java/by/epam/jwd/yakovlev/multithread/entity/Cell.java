...
import main.java.by.epam.jwd.yakovlev.multithread.entity.state.State;
import main.java.by.epam.jwd.yakovlev.multithread.entity.state.StateFree;
import main.java.by.epam.jwd.yakovlev.multithread.entity.state.StateUsed;
...
public class Cell {
    ...
    public boolean setValueIfFree(int value) {
        ...
        try {
            ...
            if (state.getName().equals(STATE_FREE)) {
                this.value = value;
                //System.out.println(getStringLocation());
    ...
    public void markAsFree(){
        ...
        //state.markAsFree(state);
    }

    public void markAsUsed(){
        state = StateUsed.getInstance();
        //state.markAsUsed(state);
    }
