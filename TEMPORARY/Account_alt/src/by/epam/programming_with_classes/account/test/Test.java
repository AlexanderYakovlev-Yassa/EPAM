...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Account ac_1 = new Account(AccountTypes.CURRENT, cl_0);
        ac_1.setBalance(1000.25f);
        ac_1.setStatus(true);

        Account ac_2 = new Account(AccountTypes.CARD, cl_0);
        ac_2.setBalance(2000f);
        ac_2.setStatus(true);

        Account ac_3 = new Account(AccountTypes.CARD, cl_0);
        ac_3.setBalance(0f);
        ac_3.setStatus(true);

        Account ac_4 = new Account(AccountTypes.CURRENT, cl_1);
        ac_4.setBalance(-500.256f);
        ac_4.setStatus(true);

        Account ac_5 = new Account(AccountTypes.CARD, cl_1);
        ac_5.setBalance(600f);
        ac_5.setStatus(true);

        Account ac_6 = new Account(AccountTypes.CARD, cl_1);
