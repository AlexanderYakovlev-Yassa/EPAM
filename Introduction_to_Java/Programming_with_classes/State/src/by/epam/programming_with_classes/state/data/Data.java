package by.epam.programming_with_classes.state.data;
...
public class Data {
    ...
    public State readStateFromFle(String file){
        int res = 0;
                ...
                while(mTag.find()){
                    ...
                    if (tagType(tag) == 0){
                        if(tagName.equals("state")){
                            ...
                            mTag.find();
                            finish = mTag.start();
                            c = logic.addCity(s,tmp.substring(start, finish));
                            if (s != null) {
                                s.setCapital(c);
                            }
                            ...
                            mTag.find();
                            finish = mTag.start();
                            if ((tmpRegion = logic.regionByName(s, tmp.substring(start, finish))) == null) {
                            ...
                            mTag.find();
                            finish = mTag.start();
                            if ((tmpDistrict = logic.districtByName(r, tmp.substring(start, finish))) == null) {
