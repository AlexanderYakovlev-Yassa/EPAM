...
public class View {
    ...
    public String carInfo(Car car){
        ...
        String moving = car.isMoving() ? "car is moving" : "car doesn't move";
    ...
    public String fuelLevel(Car car){
        try {
            double fuelLevel = car.getTank().getFuelAmount() / car.getTank().getValue() * 100;
